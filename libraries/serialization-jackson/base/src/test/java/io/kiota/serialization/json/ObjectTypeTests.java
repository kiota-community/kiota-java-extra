...
public class ObjectTypeTests {
	...
	private static class TestObject implements Parsable, AdditionalDataHolder{
	    ...
	    public static TestObject createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
		...
		public Map<String, Consumer<ParseNode>> getFieldDeserializers() {
			 final HashMap<String, java.util.function.Consumer<ParseNode>> deserializerMap = new HashMap<String, java.util.function.Consumer<ParseNode>>(9);
		        deserializerMap.put("string", (n) -> { this.setString(n.getStringValue()); });
		        deserializerMap.put("integer", (n) -> { this.setInteger(n.getIntegerValue()); });
		        deserializerMap.put("lo", (n) -> { this.setLo(n.getLongValue()); });
		        deserializerMap.put("bool", (n) -> { this.setBool(n.getBooleanValue()); });
		        deserializerMap.put("flo", (n) -> { this.setFlo(n.getFloatValue()); });
		        deserializerMap.put("doub", (n) -> { this.setDoub(n.getDoubleValue()); });
    ...
    public void deserializeObjectType() throws IOException {
        // Arrange
        JsonParseNode node = new JsonParseNode(mapper.readTree("{\"string\":\"I am a string\",\"integer\":1,\"lo\":2,\"bool\":true,\"flo\":0.1,\"doub\":0.2}"));
    ...
    public void deserializeObjectTypeWithUnknownInt() throws IOException {
        // Arrange
        JsonParseNode node = new JsonParseNode(mapper.readTree("{\"string\":\"I am a string\",\"integer\":1,\"unknownint\":2}"));
        var objValue = node.getObjectValue(TestObject::createFromDiscriminatorValue);
    ...
    public void deserializeObjectTypeWithUnknownString() throws IOException {
        // Arrange
        JsonParseNode node = new JsonParseNode(mapper.readTree("{\"string\":\"I am a string\",\"integer\":1,\"unknownstr\":\"unknown\"}"));
        var objValue = node.getObjectValue(TestObject::createFromDiscriminatorValue);
    ...
    public void deserializeObjectTypeWithUnknownFloat() throws IOException {
        // Arrange
        JsonParseNode node = new JsonParseNode(mapper.readTree("{\"string\":\"I am a string\",\"integer\":1,\"unknownfloat\":0.1}"));
        var objValue = node.getObjectValue(TestObject::createFromDiscriminatorValue);
    ...
    public void deserializeObjectTypeWithUnknownBoolean() throws IOException {
        // Arrange
        JsonParseNode node = new JsonParseNode(mapper.readTree("{\"string\":\"I am a string\",\"integer\":1,\"unknownbool\":true}"));
        var objValue = node.getObjectValue(TestObject::createFromDiscriminatorValue);
